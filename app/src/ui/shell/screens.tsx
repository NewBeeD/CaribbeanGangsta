 ...
 * these are minimal, wired PLACEHOLDERS that later prompts replace one-for-one:
 *
 *   deals → Prompt 15   empire → Prompt 16   crew  → Prompt 17
...
export const SCREENS: Readonly<Record<ScreenId, () => JSX.Element>> = {
  deals: () => <PlaceholderScreen id="deals" promptNo={15} />,
